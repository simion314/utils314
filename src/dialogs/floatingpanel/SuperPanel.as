 ...
 *
 *  @eventType dialogs.floatingpanel.SuperPanelEvent.MAXIMIZE
 */
[Event(name="maximize", type="dialogs.floatingpanel.SuperPanelEvent")]

/**
 *  Dispatched when the panel is minimized.
 *
 *  @eventType dialogs.floatingpanel.SuperPanelEvent.MINIMIZE
 */
[Event(name="minimize", type="dialogs.floatingpanel.SuperPanelEvent")]

/**
 *  Dispatched when the panel is restored from either a minimized or 
 *  maximized state.
 *
 *  @eventType dialogs.floatingpanel.SuperPanelEvent.RESTORE
 */
[Event(name="restore", type="dialogs.floatingpanel.SuperPanelEvent")]
 ...
 *
 *  @eventType dialogs.floatingpanel.SuperPanelEvent.DRAG_START
 */
[Event(name="dragStart", type="dialogs.floatingpanel.SuperPanelEvent")]

/**
 *  Dispatched while the panel is being dragged.
 *
 *  @eventType dialogs.floatingpanel.SuperPanelEvent.DRAG
 */
[Event(name="drag", type="dialogs.floatingpanel.SuperPanelEvent")]

/**
 *  Dispatched when the panel stops being dragged.
 *
 *  @eventType dialogs.floatingpanel.SuperPanelEvent.DRAG_END
 */
[Event(name="dragEnd", type="dialogs.floatingpanel.SuperPanelEvent")]

/**
 *  Dispatched when the resize handle is pressed.
 *
 *  @eventType dialogs.floatingpanel.SuperPanelEvent.RESIZE_START
 */
[Event(name="resizeStart", type="dialogs.floatingpanel.SuperPanelEvent")]

/**
 *  Dispatched when the mouse is released from the resize handle.
 *
 *  @eventType dialogs.floatingpanel.SuperPanelEvent.RESIZE_END
 */
[Event(name="resizeEnd", type="dialogs.floatingpanel.SuperPanelEvent")]
...
public class SuperPanel extends Panel
{
    ...
    private function creationCompleteHandler(event:FlexEvent):void
    {
        ...
        Logger.write("i added the moused down handler");
    ...
    {
        Logger.write("mouse down on resize ")
    	if (!_allowResize)
    		return;
    	Logger.write("mouse down on resize and can resize")
    	_isResizing = true;
                                             ...
                                             unscaledHeight:Number):void
    {
        ...
        if (resizeHitBox)
    	{
var w:int = resizeHitBox.getExplicitOrMeasuredWidth();
            var h:int = 	resizeHitBox.getExplicitOrMeasuredHeight();
    		if(w<12)w = 12;
            if(h<12)h = 12;
            resizeHitBox.setActualSize(w, h);
            
    			
    		resizeHitBox.move(unscaledWidth - resizeHitBox.width,
    						  unscaledHeight - resizeHitBox.height);
            Logger.write('resizebox '+resizeHitBox.x+" "+resizeHitBox.y+" "+resizeHitBox._width+" "+resizeHitBox._height);
