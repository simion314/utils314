...
public class HtmlUtil314 {
    ...
    public static function htmlUnescape(str:String):String {
        var my_xml:XMLDocument= new XMLDocument("<xml3>"+str+"</xml3>");
        var text:String= xmlNodeToText(my_xml.firstChild);
        return text;
    }

    private static function xmlNodeToText(node:XMLNode):String{
        if (node.nodeType == 1)
        {
